...
if USE_S3:
    ...
    STORAGES = {
        "default": {
            ...
            "OPTIONS": {"location": "media", "querystring_auth": False},
        },
        "staticfiles": {
            "BACKEND": "storages.backends.s3boto3.S3Boto3Storage",
...
DOMAIN_BYPASS_PREFIXES = (
    ...
    "/static/",
    "/media/",
    "/hub/",       # ✅ important : ne jamais rediriger le hub
)
...
# # ✅ évite de casser Postgres local / environnements sans SSL
# DB_SSL_REQUIRE = config("DB_SSL_REQUIRE", cast=bool, default=False)
...
# # ✅ IMPORTANT :
# # False => "/" affiche core/home.html (ton hub)
# # True  => "/" redirige vers la home du pôle selon domaine
# DOMAIN_REDIRECT_ROOT = False

# # si tu passes DOMAIN_REDIRECT_ROOT=True un jour :
...
# # URLs qu’on ne doit jamais rediriger (sécurité / admin / assets)
# DOMAIN_BYPASS_PREFIXES = (
#     "/admin/",
#     "/accounts/",
#     "/dashboard/",
