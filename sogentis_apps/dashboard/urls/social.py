...
from dashboard.views.social.router_page import social_router_page_view
...
urlpatterns = [
    path("", social_dashboard_router, name="index"),
    path("router/", social_router_page_view, name="router_page"),

    path("donor/", donor_home_view, name="donor_home"),
    path("donor/donations/", donor_donations_list_view, name="donor_donations_list"),
    path("donor/impact/", donor_impact_view, name="donor_impact"),
    path("donor/receipt/<int:pk>/", donor_receipt_download_view, name="donor_receipt_download"),
    ...
    path("admin/", social_admin_home_view, name="social_admin_home"),
]
...
# # dashboard/views/urls/social.py
# from django.urls import path
# from dashboard.views.social.router import social_dashboard_router
# from dashboard.views.social.router_page import social_router_page_view
...
# dashboard/urls/social.py 01/01/2026
# from django.urls import path
