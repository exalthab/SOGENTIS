...
from dashboard.views.b2b.invoices import b2b_invoices
...
urlpatterns = [
    ...
    path("invoices/", b2b_invoices, name="invoices"),

    path("users/", b2b_users_list_view, name="users"),
    path("users/create/", b2b_user_create_view, name="user_create"),
