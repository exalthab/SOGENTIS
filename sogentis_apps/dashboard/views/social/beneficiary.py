...
# optionnel: si tu n'as pas BENEFICIARY dans MembershipRole, laisse ce guard,
# ça redirigera simplement vers social index en attendant.
@require_social_role("BENEFICIARY")
def beneficiary_home_view(request):
    return render(request, "dashboard/social/beneficiary/home.html", {
        "page_title": _("Bénéficiaire"),
