# economic/prestations/admin/prestations_quote_admin.py
from __future__ import annotations

from django.contrib import admin
from django.utils.translation import gettext_lazy as _

from economic.prestations.models import Quote, QuoteLine
...
class QuoteLineInline(admin.TabularInline):
    ...
    ordering = ("order", "id")
    autocomplete_fields = ("prestation", "package")
...
class QuoteLineAdmin(admin.ModelAdmin):
    ...
    ordering = ("-created_at", "-id")
    autocomplete_fields = ("quote", "prestation", "package")
