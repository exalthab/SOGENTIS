# economic/prestations/admin/prestations_category_admin.py
...
from economic.prestations.models import PrestationCategory


@admin.register(PrestationCategory)
class PrestationCategoryAdmin(TranslatableAdmin):
    list_display = ("name_col", "slug", "is_active", "order", "is_featured", "created_at")
    list_filter = ("is_active", "is_featured")
    search_fields = ("translations__name", "slug")
    ordering = ("order", "-is_featured", "-created_at", "-id")

    @admin.display(description=_("Nom"))
    def name_col(self, obj: PrestationCategory) -> str:
...
# from economic.prestations.models import ServiceCategory
