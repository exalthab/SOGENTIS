# economic/prestations/admin/prestations_package_admin.py
...
from economic.prestations.models import PrestationPackage, PrestationPackageFeature


class PrestationPackageFeatureInline(admin.TabularInline):
    model = PrestationPackageFeature
    extra = 1
    fields = ("label", "is_highlight", "order")
    ordering = ("order", "id")


@admin.register(PrestationPackage)
class PrestationPackageAdmin(TranslatableAdmin):
    list_display = (
        "name_col",
        "tier",
        "billing_period",
    ...
    def name_col(self, obj: PrestationPackage) -> str:
...
# from economic.prestations.models import ServicePackage, ServicePackageFeature
