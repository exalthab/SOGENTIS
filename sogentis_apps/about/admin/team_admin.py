...
from about.forms.forms import TeamMemberForm  # 👈 nouveau

@admin.register(TeamMember)
class TeamMemberAdmin(TranslatableAdmin):
    form = TeamMemberForm  # 👈 branche le form (validation image + CKEditor5)
...
# # about/admin/team_admin.py --commit 06/12/2025
