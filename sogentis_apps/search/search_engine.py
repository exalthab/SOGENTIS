...
def search_index(q: str):
    """
    Postgres full-text si dispo, sinon fallback icontains.
    """
    try:
        ...
        query = SearchQuery(q)
        return (
            IndexedDocument.objects.annotate(rank=SearchRank(vector, query))
