...
from z_about_old.models import ValueItem


@admin.register(ValueItem)
class ValueItemAdmin(TranslatableAdmin):
    """
    Administration des valeurs de l’organisation.
    """
    ...
    def get_title(self, obj):
        """Retourne le titre dans la langue active ou fallback."""
        return obj.safe_translation_getter("title", any_language=True)
    get_title.short_description = _("Titre")

    def image_preview(self, obj):
        """Aperçu visuel de l'image associée."""
        if obj.image:
            return format_html(
