...
from accounts_users.web.views.auth_choice import auth_choice_view
from accounts_users.web.views.auth_web_views import login_view
...
urlpatterns = [
    ...
    # path("register/social/", register_social_view, name="register_social"),
