...
def validate_pdf(file, *, max_mb=2, required=False, label=_("Le fichier")):
    ...
    if not content_type and name and not name.endswith(".pdf"):
        raise ValidationError(_("Le fichier doit être un PDF."))
...
# ======================================================
# CLIENT (B2C) — uniquement champs métier (pas password)
# ======================================================
...
# ======================================================
# VENDEUR — champs métier + PDF obligatoire
# ======================================================
class VendorSignupForm(forms.ModelForm):
    ...
    def clean_trade_register_document(self):
        ...
        return validate_pdf(file, max_mb=2, required=True, label=_("Le registre de commerce"))


# ======================================================
# ENTREPRISE / B2B — PDF légal obligatoire + financier optionnel
# ======================================================
class CompanySignupForm(forms.ModelForm):
    ...
    def clean_registration_document(self):
        ...
        return validate_pdf(file, max_mb=2, required=True, label=_("Le document d’enregistrement"))

    def clean_financial_document(self):
        file = self.cleaned_data.get("financial_document")
        return validate_pdf(file, max_mb=2, required=False, label=_("Le document financier"))
...
#     # fallback extension check si content_type absent
#     if content_type and content_type != "application/pdf":
#         raise ValidationError(_("Le fichier doit être un PDF."))
#     if not content_type and name and not name.endswith(".pdf"):
#         raise ValidationError(_("Le fichier doit être un PDF."))
...
#     # certains serveurs ne remplissent pas content_type -> fallback sur l'extension
#     if content_type and content_type != "application/pdf":
#         raise ValidationError(_("Le fichier doit être un PDF."))
#     if not content_type and name and not name.endswith(".pdf"):
#         raise ValidationError(_("Le fichier doit être un PDF."))
