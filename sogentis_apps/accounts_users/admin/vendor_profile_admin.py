...
class VendorProfileAdmin(BaseAdmin):
    list_display = ("id", "profile", "business_name", "ninea", "postal_code", "verified", "created_at_display")
    list_filter = ("verified", "created_at")
    search_fields = ("business_name", "ninea", "profile__user__email")
    ordering = ("-created_at",)
    ...
    fieldsets = (
        ...
        (_("Informations commerciales"), {"fields": ("business_name", "ninea", "business_address", "postal_code", "verified")}),
        (_("Documents"), {"fields": ("trade_register_document",)}),
