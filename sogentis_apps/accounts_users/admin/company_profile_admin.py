...
class CompanyProfileAdmin(BaseAdmin):
    list_display = ("id", "profile", "company_name", "owner_name", "postal_code", "verified", "created_at_display")
    list_filter = ("verified", "created_at")
    search_fields = ("company_name", "owner_name", "profile__user__email")
    ordering = ("-created_at",)
    ...
    fieldsets = (
        ...
        (_("Informations entreprise"), {"fields": ("company_name", "owner_name", "company_address", "postal_code", "verified")}),
        (_("Documents légaux"), {"fields": ("registration_document", "financial_document")}),
